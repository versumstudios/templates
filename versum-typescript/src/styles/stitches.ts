...
export const DarkTheme = {
  ...
  $colors$secondaryBackground: '#1c1d1f',
  ...
  $colors$primaryBorder: 'rgba(255, 255, 255, 0.1)',
  $colors$secondaryBorder: 'rgba(255, 255, 255, 0.2)',
...
export const LightTheme = {
  ...
  $colors$primaryHighlight: '#0971f1',
  $colors$secondaryHighlight: '#227ff2',
  $colors$primaryBorder: 'rgba(0, 0, 0, 0.1)',
  $colors$secondaryBorder: 'rgba(0, 0, 0, 0.2)',
  $colors$primaryError: '#f9153e',
  $colors$secondaryError: '#190206',
};
...
export const { theme, styled, getCssText, css, keyframes, globalCss } = createStitches({
  theme: {
    fonts: { DMSans: 'DM Sans, sans-serif', mono: 'monospace' },
    space: {
      1: '64px',
      2: '32px',
      3: '16px',
